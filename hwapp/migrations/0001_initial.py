    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_recurrence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recurrence', to='hwapp.recurrence')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hw_title', models.TextField()),
                ('priority', models.IntegerField()),
                ('notes', models.TextField()),
                ('hw_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hw_class', to='hwapp.class')),
        ...
        migrations.AddField(
            model_name='class',
            name='days',
            field=models.ManyToManyField(to='hwapp.Days'),
        ),
    ]
